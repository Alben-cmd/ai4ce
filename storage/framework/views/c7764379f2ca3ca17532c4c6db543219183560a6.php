...
<!-- team -->
	...
	<div class="banner_w3lspvt-2">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="<?php echo e(route('symposium.daytwo')); ?>" class="font-weight-bold">Day 2</a></li>
			<li class="breadcrumb-item"><a href="<?php echo e(route('symposium.daythree')); ?>" class="font-weight-bold">Day 3</a></li>
      <li class="breadcrumb-item"aria-current="page">Posters</li>
		</ol> 
    <p align="center"><b>Posters Presented</b></p>
	</div>
